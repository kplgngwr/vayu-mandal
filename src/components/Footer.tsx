        ...
        <footer className="mt-12 border-t border-border-light dark:border-border-dark bg-surface-light dark:bg-surface-dark text-text-dark dark:text-white">
            ...
            <div className="mx-auto grid max-w-7xl grid-cols-1 gap-10 px-4 py-10 md:grid-cols-12">
                ...
                <div className="md:col-span-3">
                    <h3 className="mb-3 text-base font-semibold tracking-tight uppercase">Other Links</h3>
                    <ul className="space-y-2 text-sm text-text-muted-light dark:text-text-muted">
                        <li>
                            <Link className="hover:text-text-dark dark:hover:text-white hover:underline" href="#">
                                Contact Us
                            </Link>
                        </li>
                        <li>
                ...
                <div className="md:col-span-4">
                    ...
                    <div className="mt-4 space-y-1 text-sm text-text-muted-light dark:text-text-muted">
                        <div>or contact on:</div>
                        <div className="text-primary-light-theme dark:text-primary font-medium">+91-9227898608</div>
                    </div>
                    {/* Social Icons */}
                    <div className="mt-4 flex items-center gap-3">
                        <a
                            href="#"
                            title="Facebook"
                            className="inline-grid h-8 w-8 place-items-center rounded-full bg-card-light dark:bg-card-dark text-sm ring-1 ring-border-light dark:ring-border-dark hover:bg-primary-light-theme hover:text-white dark:hover:bg-primary transition-all"
                        >
